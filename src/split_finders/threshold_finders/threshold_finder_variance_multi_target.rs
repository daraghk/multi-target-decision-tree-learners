use crate::{
    calculations::variance_multi_target::{calculate_loss_vector, calculate_variance_vector},
    dataset::DataSet,
    feature_sorter::get_sorted_feature_tuple_vector,
};

use super::BestThresholdResult;
use crate::calculations::variance_multi_target::MultiTargetLabelMetrics;
...
pub(super) fn determine_best_threshold(
    ...
    let mut right_value_tracker = VarianceValueTrackerMultiTarget {
        ...
        multi_target_label_metrics: MultiTargetLabelMetrics {
            ...
            sum_of_labels_vector: total_multi_target_label_metrics.sum_of_labels_vector,
            mean_of_labels_vector: total_multi_target_label_metrics.mean_of_labels_vector,
        },
    };
...
mod tests {
    use crate::{
        calculations::variance_multi_target::get_multi_target_label_metrics,
        data_reader::{read_csv_data, read_csv_data_multi_target},
        dataset::DataSet,
    };
    ...
    fn test_best_threshold_for_particular_feature_in_iris() {
        let iris = read_csv_data_multi_target("./data_arff/iris.csv", false);
        let column = 2;
