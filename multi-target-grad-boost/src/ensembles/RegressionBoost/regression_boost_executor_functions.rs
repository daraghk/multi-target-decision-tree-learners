...
use common::{
    ...
    numerical_calculations::{add_f64_slices_as_vector, subtract_f64_slices_as_vector},
};
    ...
    for _i in 0..number_of_iterations {
        ...
        );
        {
            for i in 0..training_data.size {
                let weighted_leaf_output = map_data_indices_to_weighted_leaf_output.get(&i).unwrap();
