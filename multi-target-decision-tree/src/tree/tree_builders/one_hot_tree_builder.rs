...
#[cfg(test)]
mod tests {
    use crate::{decision_tree::OneHotMultiTargetDecisionTree, printer::{print_tree, print_tree_regression}, split_finder::{SplitFinder, SplitMetric}};
    ...
    fn test_build_tree() {
        ...
        let tree = OneHotMultiTargetDecisionTree::new(
            data_set.clone(),
            tree_config,
        );
